...
(async() => {
    ...
    const mintAddresses = ["0x744b65d2909fe2ec7e556e02252009bf0265e4e4","0x99a64210cfc0c1aed571b25bca654e593827b149"];

    console.log(generateMerkleProof(mintAddresses, whitelistAddresses))
